#******************************************************************************
# Generated by VisualTeensy V1.5.0 on 12.05.2022 at 15:24
#
# Board              Teensy 4.0
...
TARGET_NAME      := Control-S1
BOARD_ID         := TEENSY40

MCU              := imxrt1062

LIBS_SHARED_BASE := C:\Users\Mirek\Documents\Arduino\libraries
LIBS_SHARED      := Adafruit_GFX_Library Adafruit_BusIO
...
DEFINES     += -DF_CPU=600000000 -DLAYOUT_US_ENGLISH

ifeq ($(teensyconfig),)
$(warning No Teensy config specified)
$(info Usage: >> make teensyconfig={config})
endif

ifeq ($(teensyconfig), Serial_MIDIx16_Audio)
DEFINES += -DUSB_MIDI16_AUDIO_SERIAL
endif

ifeq ($(teensyconfig), Serial_MIDIx16)
DEFINES += -DUSB_MIDI16_SERIAL
endif

ifeq ($(teensyconfig), Serial_MIDIx4)
DEFINES += -DUSB_MIDI4_SERIAL
endif

ifeq ($(teensyconfig), Serial_MIDI)
